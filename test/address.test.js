...
describe('interaction with firebase', () => {
  ...
  it('Create multiples Voting Address ', async (done) => {
    const token = await getToken();
    const payload = [{
      collateralHash: 'edb941c1f19710635ded3e8293298f83dbb03d9f2cfc92b76b5bcda7ea62690b',
      collateralIndex: 0,
    ...
    {
      collateralHash: 'edb941c1f19710635ded3e8293298f83dbb03d9f2cfc92b76b5bcda7ea62690c',
      collateralIndex: 0,
      collateralHeight: 543088,
