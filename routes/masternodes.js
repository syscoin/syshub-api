...
const {list, info, countMasterNodes, getAllMasterNodesByUser, masterNodeVoteIn, getMiningInfo, createMasterNode, updateMaterNode, destroyMasterNode, getGovernanceInfo, getSuperBlockBudget, getMasterNode} = require('../controllers/masternode');
