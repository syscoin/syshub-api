...
app.get('', [clientApp], (req, res) => res.status(200).json({status: 'ok', api: 'Syshub'}));
...
app.use('/user', [clientApp], user);
app.use('/auth', [clientApp], auth);
app.use('/proposal', [clientApp], proposal);
app.use('/masternode', [clientApp], masterNode);
